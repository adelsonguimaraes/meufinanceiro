...
Class TaxaadministrativaControl {
	//atributos
	protected $con;
	protected $obj;
	protected $objDAO;
	...
	//construtor
	public function __construct(Taxaadministrativa $obj=NULL) {
		$this->con = conexao::getInstance()->getConexao();
		$this->objDAO = new TaxaadministrativaDAO($this->con);
		$this->obj = $obj;
	}
