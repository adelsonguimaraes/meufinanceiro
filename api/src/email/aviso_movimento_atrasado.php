...
<a href="https://www.adelsonguimaraes.com.br/meufinanceiro/" style="text-decoration:none;">
    <div style="border: 1px solid black; min-height: 250px; width: 600px; padding:10px; background: #a55a5a;">
        <div style="padding:15px; width:100%; color: black; text-align: center; font-size: 35px;font-family: sans-serif;">AVISO DE ATRASO</div>
        <div style="display: flex; padding: 10px;">
            ...
            <div style="flex:1; padding: 10px; color:black;font-size: 18px; font-family: sans-serif; text-align: justify;">
                Olá <b><?php echo $data['nome'];?></b>, alguns de seus movimentos estão atrasados há <?php echo ($dias_atraso*-1) ?> dias (<?php echo formatDate($data['vencimento']) ?>).
                <br><br>
