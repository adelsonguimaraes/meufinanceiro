...
function cadastrar () {
	...
	$control = new usuario_control($obj);
...
function buscarPorId () {
	$data = $_POST['data'];
	$control = new usuario_control(new usuario($data['id']));
...
function listar () {
	$control = new usuario_control(new usuario);
...
function listarPorSuperior () {
	...
	echo json_encode($usuario_control->listarPorSuperior($usuario["idusuario"]));
}
function atualizar () {
	$data = $_POST['data'];
	$obj = new usuario();
...
function deletar () {
	...
	$banco = new usuario();
	$banco->setId($data['id']);
	$control = new usuario_control($banco);
